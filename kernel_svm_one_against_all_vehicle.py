...
for k in K: # k-time-k-fold CV
    ...
    grid = GridSearchCV(OneVsRestClassifier(SVC()), param_grid=param_grid,
    ...
    print(np.max(test_acc)) # or print(grid.best_score_)
